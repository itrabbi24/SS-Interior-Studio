    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="categoryModalLabel">Add Portfolio Category</h5>
...
$(function () {
    ...
    $('#addCategoryBtn').click(function () {
        ...
        $('#category_id').val('');
        $('#nameError').text('');
        $('#categoryModalLabel').text('Add Portfolio Category');
    });
    ...
    $(document).on('click', '.edit-btn', function () {
        ...
        $('#nameError').text('');
        $('#categoryModalLabel').text('Edit Portfolio Category');
        categoryModal.show();
    });
    ...
    $('#categoryForm').submit(function (e) {
        ...
        var url = id ? "{{ url('portfolio-categories') }}/" + id : "{{ route('portfolio-categories.store') }}";
    ...
    $(document).on('click', '.delete-btn', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('portfolio-categories') }}/" + id,
                    type: 'DELETE',
