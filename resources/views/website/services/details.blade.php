...
@section('title', 'Services Details - SS Interior')
											...
											<div class="row">
												<div class="col-md-6 text-center">
													<div class="pbmit-animation-style1">
														<img src="images/service/service-det-02.jpg" class="img-fluid" alt="">
													</div>
												</div>
												<div class="col-md-6 text-center">
													<div class="pbmit-animation-style2">
														<img src="images/service/service-det-03.jpg" class="img-fluid" alt="">
													</div>
												</div>
											</div>
										</div>
										<div>In design, we bring characteristics of the natural world into built spaces, such as water, greenery, and natural light, or elements like wood and stone. Encouraging the use of natural systems and processes in design allows for exposure to nature, and in turn, these design approaches improve health and wellbeing. There are a number of possible benefits, including reduced heart rate variability and pulse rates, decreased blood pressure, and increased activity in our nervous systems, to name a few.</div>
										<div class="fid-style-rea">
											<div class="row">
												<div class="col-md-4">
													<div class="pbminfotech-ele-fid-style-3">
														<div class="pbmit-fld-contents">
															<div class="pbmit-circle-outer" data-digit="87" data-fill="#bb9a65" data-emptyfill="" data-before="" data-after="<span>%</span>" data-thickness="1.5" data-size="153">
															...
															<div class="pbmit-fid-sub">
																<h3 class="pbmit-fid-title">3D modeling</h3>
																<div class="pbmit-heading-desc">Studio provides a full range of 3D interior modeling</div>
															</div>
														</div>
													</div>
												</div>
												<div class="col-md-4">
													<div class="pbminfotech-ele-fid-style-3">
														<div class="pbmit-fld-contents">
															<div class="pbmit-circle-outer" data-digit="57" data-fill="#bb9a65" data-emptyfill="" data-before="" data-after="<span>%</span>" data-thickness="1.5" data-size="153">
																<div class="pbmit-circle">
																	<div class="pbmit-fid-inner">
																		<span class="pbmit-fid-before"></span>
																		<span class="pbmit-number-rotate numinate" data-appear-animation="animateDigits" data-from="0" data-to="57" data-interval="5" data-before="" data-before-style="" data-after="" data-after-style="">57</span>
																		<span class="pbmit-fid"><span>%</span></span>
																	</div>
																</div>
															</div>
															<div class="pbmit-fid-sub">
																<h3 class="pbmit-fid-title">Room Measurement</h3>
																<div class="pbmit-heading-desc">Studio provides a full range of 3D interior modeling</div>
															</div>
														</div>
													</div>
												...
												<div class="col-md-4">
													<div class="pbminfotech-ele-fid-style-3">
														<div class="pbmit-fld-contents">
															<div class="pbmit-circle-outer" data-digit="99" data-fill="#bb9a65" data-emptyfill="" data-before="" data-after="<span>%</span>" data-thickness="1.5" data-size="153">
																<div class="pbmit-circle">
																	<div class="pbmit-fid-inner">
																		<span class="pbmit-fid-before"></span>
															...
															<div class="pbmit-fid-sub">
																<h3 class="pbmit-fid-title">2d planning</h3>
																<div class="pbmit-heading-desc">Studio provides a full range of 3D interior modeling</div>
															</div>
														</div>
													</div>
								...
								<aside class="service-sidebar">
									<aside class="widget post-list">
										...
										<div class="all-post-list">
											<ul>
												<li><a href=" service-details"> Transforming Rooms </a></li>
												<li><a href=" service-details"> Weaving Dreams </a></li>
												<li><a href=" service-details"> Interior Decorator </a></li>
												<li><a href=" service-details"> Professional Interior </a></li>
												<li><a href=" service-details"> Interior Work Plan </a></li>
												<li><a href=" service-details"> 2D/3D Layouts </a></li>
									...
									<aside class="widget pbmit-service-ad">
										<div class="textwidget">
											<div class="pbmit-service-ads">
												<h5 class="pbmit-ads-subheding">Contact Us</h5>
												<h4 class="pbmit-ads-subtitle">Need Assistance?</h4>
												<h3 class="pbmit-ads-title">Support</h3>
												<div class="pbmit-ads-desc">
													<i class="pbmit-base-icon-phone-call-1"></i>01949405772
												</div>
										...
										<div class="textwidget">
											<div class="download">
												<div class="item-download">
													<a href="{{ asset('public/files/ss-interior-company-profile.pdf') }}" target="_blank" rel="noopener noreferrer">
