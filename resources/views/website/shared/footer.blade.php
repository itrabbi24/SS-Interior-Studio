                    ...
                    <aside class="widget_text widget">
                        ...
                        <div class="textwidget">
                            <div class="pbmit-contact-widget-lines">
                                <div class="pbmit-contact-widget-phone">01949405772</div>
                                <div class="pbmit-contact-widget-email">ssinterior2233@gmail.com</div>
                            </div>
                        </div>
                    </aside>
                </div>
    ...
    <div class="pbmit-footer-text-area">
        <div class="container">
            <div class="pbmit-footer-text-inner">
                <div class="row">
                    <div class="col-md-6">
                       <div class="pbmit-footer-copyright-text-area"> Copyright © 2025 <a href="{{ url('/') }}">SS Interior</a> All Rights Reserved.</div>
                    </div>
                    <div class="col-md-6">
                        <div class="pbmit-footer-menu-area">
                            <div class="menu-footer-menu-container">
                                <ul class="pbmit-footer-menu">
                                    <li><a href="https://www.rotexit.com" target="_blank"><span>Developed By: RotexIT</span></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
